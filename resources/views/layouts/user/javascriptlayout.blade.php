...
<script type="text/javascript" src="{{ asset('js_user/jquery.bootstrap-touchspin.js') }}"></script>
<script type="text/javascript" src="{{ asset('js_user/dropzone.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('js_user/jquery-ui.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('js_user/jquery.ui.timepicker.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('js_user/bootstrap-tagsinput.min.js') }}"></script>
