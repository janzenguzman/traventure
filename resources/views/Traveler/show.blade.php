													...
													<ul class="clearfix">
														<li class="row gap-20">
															...
															<div class="col-xs-12 col-sm-5 text-primary text-right text-left-xs mt-xs space">
																PHP {{ number_format($package->pax1_price, 2) }}
															</div>
														</li>
														<li class="row gap-20">
															<div class="col-xs-12 col-sm-3">
															...
															<div class="col-xs-12 col-sm-5 text-primary text-right text-left-xs mt-xs space">
																PHP {{ number_format($package->pax2_price, 2) }}
															</div>
														</li>
														<li class="row gap-20">
															<div class="col-xs-12 col-sm-3">
															...
															<div class="col-xs-12 col-sm-5 text-primary text-right text-left-xs mt-xs space">
																PHP {{ number_format($package->pax3_price, 2) }}
															</div>
														</li>
														<li class="row gap-20">
															<div class="col-xs-12 col-sm-3">
															...
															<div class="col-xs-12 col-sm-5 text-primary text-right text-left-xs mt-xs space">
																PHP {{ number_format($package->excess_price, 2) }}
															</div>
														</li>
													</ul>
												@else
													<ul class="clearfix">
														<li class="row gap-20">
															...
															<div class="col-xs-12 col-sm-5 text-primary text-right text-left-xs mt-xs space">
																PHP {{ number_format($package->adult_price, 2) }}
															</div>
														</li>
														<li class="row gap-20">
															<div class="col-xs-12 col-sm-7">
															...
															<div class="col-xs-12 col-sm-5 text-primary text-right text-left-xs mt-xs space">
																PHP {{ number_format($package->child_price, 2) }}
															</div>
														</li>
														<li class="row gap-20">
															<div class="col-xs-12 col-sm-7">
															...
															<div class="col-xs-12 col-sm-5 text-primary text-right text-left-xs mt-xs space">
																PHP {{ number_format($package->infant_price, 2) }}
															</div>
														</li>
													</ul>
