...
<style>
    ...
    width: 100px;
        ...
        {!!Form::open(array('method' => 'post', 'enctype' => 'multipart/form-data','action' => array('AgentsController@updateItineraries', $itineraries->package_id)))!!}
@if(count($packages) > 0)
    @if($packages->days == 1)
        ...
        <div class="form-group">
            ...
            <input type="text" name="day1_starttime1" value="{{ $itineraries->day1_starttime1 }}" class="form-control" placeholder="Time">
        </div>
        <div class="form-group">
            <label>End Time:</label>
            <input type="text" name="day1_endtime1" value="{{ $itineraries->day1_endtime1 }}" class="form-control" placeholder="Time">
        </div>
        <div class="form-group">
            <label>Destinations:</label>
            <input type="text" name="day1_destination1"value="{{ $itineraries->day1_destination1 }}" class="form-control" placeholder="Destination">
        </div>
        <div class="form-group">
            <label>Start Time:</label>
            <input type="text" name="day1_starttime2"value="{{ $itineraries->day1_starttime2 }}" class="form-control" placeholder="Time">
        </div>
        <div class="form-group">
            <label>End Time:</label>
            <input type="text" name="day1_endtime2"value="{{ $itineraries->day1_endtime2 }}" class="form-control" placeholder="Time">
        </div>
        <div class="form-group">
            <label>Destinations:</label>
            <input type="text" name="day1_destination2"value="{{ $itineraries->day1_destination2 }}" class="form-control" placeholder="Destination">
        </div>
        <div class="form-group">
            <label>Start Time:</label>
            <input type="text" name="day1_starttime3"value="{{ $itineraries->day1_starttime3 }}" class="form-control" placeholder="Time">
        </div>
        <div class="form-group">
            <label>End Time:</label>
            <input type="text" name="day1_endtime3"value="{{ $itineraries->day1_endtime3 }}" class="form-control" placeholder="Time">
        </div>
        <div class="form-group">
            <label>Destinations:</label>
            <input type="text" name="day1_destination3"value="{{ $itineraries->day1_destination3 }}" class="form-control" placeholder="Destination">
        </div>
        <div class="form-group">
            <label>Start Time:</label>
            <input type="text" name="day1_starttime4"value="{{ $itineraries->day1_starttime4 }}" class="form-control" placeholder="Time">
        </div>
        <div class="form-group">
            <label>End Time:</label>
            <input type="text" name="day1_endtime4"value="{{ $itineraries->day1_endtime4 }}" class="form-control" placeholder="Time">
        </div>
        <div class="form-group">
            <label>Destinations:</label>
            <input type="text" name="day1_destination4"value="{{ $itineraries->day1_destination4 }}" class="form-control" placeholder="Destination">
        </div>
        <div class="form-group">
            <label>Start Time:</label>
            <input type="text" name="day1_starttime5"value="{{ $itineraries->day1_starttime5 }}" class="form-control" placeholder="Time">
        </div>
        <div class="form-group">
            <label>End Time:</label>
            <input type="text" name="day1_endtime5"value="{{ $itineraries->day1_endtime5 }}" class="form-control" placeholder="Time">
        </div>
        <div class="form-group">
            <label>Destinations:</label>
            <input type="text" name="day1_destination5"value="{{ $itineraries->day1_destination5 }}" class="form-control" placeholder="Destination">
        </div>
        <div class="form-group">
            <label>Upload Photo:</label>
            <input type="file" name="day1_photo" required>
        </div>
    @endif
    ...
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day2_starttime1" value="{{ $itineraries->day2_starttime1 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day2_endtime1" value="{{ $itineraries->day2_endtime1 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day2_destination1"value="{{ $itineraries->day2_destination1 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day2_starttime2" value="{{ $itineraries->day2_starttime2 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day2_endtime2" value="{{ $itineraries->day2_endtime2 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day2_destination2"value="{{ $itineraries->day2_destination2 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day2_starttime3" value="{{ $itineraries->day2_starttime3 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day2_endtime3" value="{{ $itineraries->day2_endtime3 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day2_destination3"value="{{ $itineraries->day2_destination3 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day2_starttime4" value="{{ $itineraries->day2_starttime4 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day2_endtime4" value="{{ $itineraries->day2_endtime4 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day2_destination4"value="{{ $itineraries->day2_destination4 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day2_starttime5" value="{{ $itineraries->day2_starttime5 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day2_endtime5" value="{{ $itineraries->day2_endtime5 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day2_destination5"value="{{ $itineraries->day2_destination5 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Upload Photo:</label>
    ...
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day3_starttime1" value="{{ $itineraries->day3_starttime1 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day3_endtime1" value="{{ $itineraries->day3_endtime1 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day3_destination1"value="{{ $itineraries->day3_destination1 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day3_starttime2" value="{{ $itineraries->day3_starttime2 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day3_endtime2" value="{{ $itineraries->day3_endtime2 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day3_destination2"value="{{ $itineraries->day3_destination2 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day3_starttime3" value="{{ $itineraries->day3_starttime3 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day3_endtime3" value="{{ $itineraries->day3_endtime3 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day3_destination3"value="{{ $itineraries->day3_destination3 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day3_starttime4" value="{{ $itineraries->day3_starttime4 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day3_endtime4" value="{{ $itineraries->day3_endtime4 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day3_destination4"value="{{ $itineraries->day3_destination4 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day3_starttime5" value="{{ $itineraries->day3_starttime5 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day3_endtime5" value="{{ $itineraries->day3_endtime5 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day3_destination5"value="{{ $itineraries->day3_destination5 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Upload Photo:</label>
    ...
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day4_starttime1" value="{{ $itineraries->day4_starttime1 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day4_endtime1" value="{{ $itineraries->day4_endtime1 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day4_destination1"value="{{ $itineraries->day4_destination1 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day4_starttime2" value="{{ $itineraries->day4_starttime2 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day4_endtime2" value="{{ $itineraries->day4_endtime2 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day4_destination2"value="{{ $itineraries->day4_destination2 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day4_starttime3" value="{{ $itineraries->day4_starttime3 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day4_endtime3" value="{{ $itineraries->day4_endtime3 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day4_destination3"value="{{ $itineraries->day4_destination3 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day4_starttime4" value="{{ $itineraries->day4_starttime4 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day4_endtime4" value="{{ $itineraries->day4_endtime4 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day4_destination4"value="{{ $itineraries->day4_destination4 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day4_starttime5" value="{{ $itineraries->day4_starttime5 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day4_endtime5" value="{{ $itineraries->day4_endtime5 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day4_destination5"value="{{ $itineraries->day4_destination5 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Upload Photo:</label>
    ...
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day5_starttime2"value="{{ $itineraries->day5_starttime2 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day5_endtime2"value="{{ $itineraries->day5_endtime2 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day5_destination2"value="{{ $itineraries->day5_destination2 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day5_starttime3"value="{{ $itineraries->day5_starttime3 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day5_endtime3"value="{{ $itineraries->day5_endtime3 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day5_destination3"value="{{ $itineraries->day5_destination3 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day5_starttime4"value="{{ $itineraries->day5_starttime4 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day5_endtime4"value="{{ $itineraries->day5_endtime4 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day5_destination4"value="{{ $itineraries->day5_destination4 }}" class="form-control" placeholder="Destination">
    </div>
    <div class="form-group">
        <label>Start Time:</label>
        <input type="text" name="day5_starttime5"value="{{ $itineraries->day5_starttime5 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>End Time:</label>
        <input type="text" name="day5_endtime5"value="{{ $itineraries->day5_endtime5 }}" class="form-control" placeholder="Time">
    </div>
    <div class="form-group">
        <label>Destinations:</label>
        <input type="text" name="day5_destination5"value="{{ $itineraries->day5_destination5 }}" class="form-control" placeholder="Destination">
    </div>
    <div>
        <label>Upload Photo</label>
                                                                ...
                                                                <div class="col-xss-12 col-xs-10 col-sm-10 col-md-11">
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day1_destination1" class="form-control" value="{{ $itineraries->day1_destination1 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day1_destination2" class="form-control" value="{{ $itineraries->day1_destination2 }}" >
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day1_destination3" class="form-control" value="{{ $itineraries->day1_destination3 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day1_destination4" class="form-control" value="{{ $itineraries->day1_destination4 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day1_destination5" class="form-control" value="{{ $itineraries->day1_destination5 }}">
                                                                            </div>
                                                                ...
                                                                <div class="col-xss-12 col-xs-10 col-sm-10 col-md-11">
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day2_destination1" class="form-control" placeholder="Destination" value="{{ $itineraries->day2_destination1 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day2_destination2" class="form-control" value="{{ $itineraries->day2_destination2 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day2_destination3" class="form-control"  value="{{ $itineraries->day2_destination3 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day2_destination4" class="form-control" value="{{ $itineraries->day2_destination4 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day2_destination5" class="form-control"  value="{{ $itineraries->day2_destination5 }}">
                                                                            </div>
                                                                ...
                                                                <div class="col-xss-12 col-xs-10 col-sm-10 col-md-11">
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day2_destination1" class="form-control" value="{{ $itineraries->day2_destination1 }}">
                                                                            </div>
                                                                ...
                                                                <div class="col-xss-12 col-xs-10 col-sm-10 col-md-11">
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day3_destination1" class="form-control" value="{{ $itineraries->day3_destination1 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day3_destination2" class="form-control" value="{{ $itineraries->day3_destination2 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day3_destination3" class="form-control" value="{{ $itineraries->day3_destination3 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day3_destination4" class="form-control" value="{{ $itineraries->day3_destination4 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day3_destination5" class="form-control" value="{{ $itineraries->day3_destination5 }}">
                                                                            </div>
                                                                ...
                                                                <div class="col-xss-12 col-xs-10 col-sm-10 col-md-11">
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day4_destination1" class="form-control" value="{{ $itineraries->day4_destination1 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day4_destination2" class="form-control" value="{{ $itineraries->day4_destination2 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day4_destination3" class="form-control" value="{{ $itineraries->day4_destination3 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day4_destination4" class="form-control" value="{{ $itineraries->day4_destination4 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day4_destination5" class="form-control" value="{{ $itineraries->day4_destination5 }}">
                                                                            </div>
                                                                ...
                                                                <div class="col-xss-12 col-xs-10 col-sm-10 col-md-11">
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="time" name="day1_destination4" class="form-control" value="{{ $itineraries->day1_destination4 }}">
                                                                            </div>
                                                                ...
                                                                <div class="col-xss-12 col-xs-10 col-sm-10 col-md-11">
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day3_destination2" class="form-control" value="{{ $itineraries->day3_destination3 }}">
                                                                            </div>
                                                                ...
                                                                <div class="col-xss-12 col-xs-10 col-sm-10 col-md-11">
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day5_destination1" class="form-control" value="{{ $itineraries->day5_destination1 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day5_destination2" class="form-control" value="{{ $itineraries->day5_destination2 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day5_destination3" class="form-control" value="{{ $itineraries->day5_destination3 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day5_destination4" class="form-control" value="{{ $itineraries->day5_destination4 }}">
                                                                            </div>
                                                                    ...
                                                                    <div class="row gap-20">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-12">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label>Destination:</label>
                                                                                <input type="text" name="day5_destination5" class="form-control" value="{{ $itineraries->day5_destination5 }}">
                                                                            </div>
